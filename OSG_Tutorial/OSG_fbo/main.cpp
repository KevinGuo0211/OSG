...
void build_world(osg::Group *root)
{
	...
	fbo->setAttachment(osg::Camera::BufferComponent(GL_COLOR_ATTACHMENT0_EXT), osg::FrameBufferAttachment(tex.get()));
	fbo->setAttachment(osg::Camera::BufferComponent(GL_DEPTH_ATTACHMENT_EXT), osg::FrameBufferAttachment(new osg::RenderBuffer(width, height, GL_DEPTH_COMPONENT24)));
